...
<div class="main-panel m-3">
  <div class="container__index">
    ...
    <h4>Berikut Adalah Hasil Scraping Dari Data Hotel Batu Suli</h4>
    <?php

    include "koneksi.php";
    $query = mysqli_query($conn, "SELECT * FROM book3");
    ...
    $query_paginate = mysqli_query($conn, "SELECT * FROM book3 LIMIT $awal_data, $jumlah_data_per_halaman");
